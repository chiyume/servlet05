...
public class SensitiveWorldFilter {
    ...
    public static void main(String[] args) throws IOException {
         ...
         * 获取语句中的敏感词
         */
        Set<String> set = SensitiveWorldFilter.getSensitiveWord(string);
        System.out.println("语句中包含敏感词的个数为：" + set.size() + "。包含：" + set);

        /**
         * 替换语句中的敏感词
         */
        String filterStr = SensitiveWorldFilter.replaceSensitiveWord(string, '*');
        System.out.println(filterStr);

        String filterStr2 = SensitiveWorldFilter.replaceSensitiveWord(string, "[*敏感词*]");
